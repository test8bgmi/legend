...
TELEGRAM_BOT_TOKEN = '7687376303:AAFito6bzjegNBTfcgf9AVxv-DFYGpF_E1g'
ALLOWED_USER_ID = 5980035995
...
async def run_attack(chat_id, ip, port, duration, context):
    try:
        ...
        await context.bot.send_message(chat_id=chat_id, text="*Thank you for using our service!*", parse_mode='Markdown')
